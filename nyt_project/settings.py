...
DATABASES = {
    'default': {
        ...
        'NAME': 'StoryDB',                      # Or path to database file if using sqlite3.
...
SECRET_KEY = '!m71vgyz9^o+h1b)hd1(j&ylmaw_j=a5j_a-c$tkm$y*tz$4e8'
...
ROOT_URLCONF = 'nyt_project.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'nyt_project.wsgi.application'
