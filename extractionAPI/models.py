...
class Image_In_Slide(models.Model):
	slide = models.ForeignKey(Slide, unique=True)			#	This enforces that each slide can only be associated with one image (but images can be related to multiple slides)
